...
<template>
  <div class="container">
    ...
    <el-table :data="tableData">
      ...
      <el-table-column prop="orderBatchId" label="批次号" align="center" header-align="center" width="180" />
      <el-table-column prop="salesman" label="所属销售" align="center" header-align="center" width="180" />
      <el-table-column prop="orderFileKey" label="订单文件名称" align="center" header-align="center" width="180" />
      <el-table-column prop="customerName" label="客户名称" align="center" header-align="center" width="180" />
      <el-table-column prop="orderTotal" label="订单总数" align="center" header-align="center" width="180" />
      <el-table-column prop="orderStatus" label="订单情况" align="center" header-align="center" width="180" />
      <el-table-column prop="exceptionStatus" label="异常情况" align="center" header-align="center" width="180" />
      <el-table-column prop="createdAt" label="导入时间" align="center" header-align="center" width="180" />
      <el-table-column prop="exportedToCustomer" label="导出给客户" align="center" header-align="center" width="180" />
    </el-table>
    <el-pagination
      background
